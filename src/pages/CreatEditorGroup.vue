<template>
  ...
  <div class="wrapper">
    <Header goback='true'
      chatTitle="群资料"></Header>
    <Message-box :messageBoxEvent="this.messageBox.messageBoxEvent"
    ...
    <div class="content">
      <div class="">
        <img :src="groupInfo.group_avator"
          alt="">
      </div>
      <p>群名:</br><input type="text"
          v-model="groupInfo.group_name"
          placeholder="不超过10个字哦"
          maxlength="10" /></p>
      <p>群公告:</br><textarea rows="5"
          type="text"
